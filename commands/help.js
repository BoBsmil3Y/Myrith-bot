module.exports.run = async (l, Discord, bot, m, args) => {
  ...
  let embed = new Discord.RichEmbed()
    ...
    .setDescription("Si tu as des idées de commandes à ajouter, n'hésite pas à nous les envoyers !\n Les '&' dans les commandes sont très importants et permettent de séparer les différentes sections de ton report, ne les oublie pas, et n'en met pas dans tes phrases !")
